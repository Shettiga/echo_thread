...
class _RegisterScreenState extends State<RegisterScreen>
  ...
  void initState() {
    ...
    _bgAnim1 = Tween<double>(begin: -28.0, end: 28.0).animate(
      CurvedAnimation(parent: _bgController, curve: Curves.easeInOut),
    );
    _bgAnim2 = Tween<double>(begin: -18.0, end: 18.0).animate(
      CurvedAnimation(parent: _bgController, curve: Curves.easeInOutCubic),
    );
    _bgAnim3 = Tween<double>(begin: -36.0, end: 36.0).animate(
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              shape: BoxShape.circle,
              gradient: LinearGradient(colors: [Colors.white.withOpacity(0.3), Colors.white.withOpacity(0.08)]),
            ),
            ...
            child: Column(
              ...
              children: [
                Text('Create your account',
                    style: TextStyle(
                        color: Colors.white.withOpacity(0.94), fontWeight: FontWeight.w700)),
                const SizedBox(height: 4),
                Text('Join donors, NGOs and volunteers in three easy steps.',
                    style: TextStyle(color: Colors.white.withOpacity(0.76), fontSize: 12.5)),
              ],
            ),
          ),
        ],
          ...
          return Stack(
            children: [
              Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: const [Color(0xFF123B26), Color(0xFF1D6B31), Color(0xFF57B65A), Color(0xFFB5E6B0)],
                    begin: Alignment(-1.0 + (shift * 0.12), -1.0),
                    end: Alignment(1.0, 1.0 - (shift * 0.12)),
                  ),
                ),
              ),
              Positioned.fill(
                child: Stack(
                  children: [
                    Positioned(left: -40 + _bgAnim1.value, top: -50 + (_bgAnim2.value / 2), child: _buildGlowBlob(size: 220, colors: [Colors.white.withOpacity(0.09), Colors.transparent])),
                    Positioned(right: -70 - _bgAnim2.value, top: 80 + (_bgAnim3.value / 3), child: _buildGlowBlob(size: 260, colors: [Colors.white.withOpacity(0.08), Colors.transparent])),
                    Positioned(right: 18 + _bgAnim3.value, bottom: -80 - (_bgAnim1.value / 2), child: _buildGlowBlob(size: 300, colors: [Colors.white.withOpacity(0.10), Colors.transparent])),
                  ],
                ),
              ),
              SafeArea(
                    ...
                    child: Padding(
                      ...
                      child: ConstrainedBox(
                        ...
                        child: Column(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            FadeTransition(opacity: _cardFadeAnimation, child: ScaleTransition(scale: _cardScaleAnimation, child: _buildHeroStrip())),
                              ...
                              child: ScaleTransition(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: BackdropFilter(
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                        gradient: LinearGradient(colors: [Colors.white.withOpacity(0.14), Colors.white.withOpacity(0.08)]),
                                        borderRadius: BorderRadius.circular(30),
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: GestureDetector(
                                                    ...
                                                    child: AnimatedContainer(
                                                      ...
                                                      height: 54,
                                                      decoration: BoxDecoration(
                                                        gradient: const LinearGradient(colors: [Color(0xFF0F4F22), Color(0xFF67C56A), Color(0xFFB6E6B2)], begin: Alignment.centerLeft, end: Alignment.centerRight),
                                                        borderRadius: BorderRadius.circular(16),
                                                        boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.2), blurRadius: 14, offset: const Offset(0, 8))],
                                                      ),
                                                      child: AnimatedSwitcher(
                                                        duration: const Duration(milliseconds: 250),
                                                        child: _isLoading ? const SizedBox(height: 20, width: 20, child: CircularProgressIndicator(strokeWidth: 2.4, valueColor: AlwaysStoppedAnimation<Color>(Colors.white))) : const Center(child: Text('Register', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w700))),
                                                      ),
                                                    ),
                                                  ),
                                                ),
...
class _RegisterTexturePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var i = 0; i < 6; i++) {
      ...
      canvas.drawLine(Offset(0, y + math.sin(progress * math.pi * 2 + i) * 6), Offset(size.width, y), paint..strokeWidth = 1);
    }
  }
